...
const CreateMeme = ({ searchParams }: { searchParams: MemeProps }) => {
    ...
    const downloadMeme = () => {
        if (generatedMemeImage) {
            saveAs(generatedMemeImage, 'generated-meme.png'); 
        } else {
                ...
                {generatedMemeImage ? (
                    <div className="flex flex-col items-center mt-4">
                        ...
                        <button
                            ...
                            className="w-full bg-gradient-to-r from-gray-700 to-slate-900 text-white font-bold py-2 px-4 rounded-lg mt-6 hover:from-gray-600 hover:to-slate-800 transition-all duration-300 transform"                        >
                            Download Meme
                        </button>
                    </div>
                ) : (
